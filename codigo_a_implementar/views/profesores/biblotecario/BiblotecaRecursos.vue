  ...
  <div class="biblioteca-container">
    <nav class="navbar">
      <div class="nav-izquierda">
        <div class="logo">
          <div>
            <img src="@/assets/logoEscuela.png" width="60" height="60">
          </div>
      ...
      <main class="main-content">
        <header class="topbar">
          <div class="header-info">
            <div class="caja">
              <img src="@/assets/libritos.png" alt="caja" width="70" height="70">
            </div>
            <div>
...
export default {
  ...
  methods: {
    verificarSesion() {
      ...
      this.userCurso = localStorage.getItem('userCurso') || 'Profesor';
    },
...
.btn-reportar:hover { background: #b32626; }
