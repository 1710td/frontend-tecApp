  ...
  <div class="cursos-wrapper">
    <div v-if="vistaActiva === 'lista'" class="card animate-fade-in">
      ...
      <div class="table-responsive">
        ...
        <table v-else-if="cursos.length > 0" class="mini" aria-label="Cursos registrados">
          <thead>
            <tr>
              <th>Nombre</th>
              <th>Nivel</th>
          ...
          <tbody>
            <tr v-for="curso in cursos" :key="curso.id_curso" class="table-row">
      ...
      <form @submit.prevent="guardarCurso" class="form-body">
        <div class="form-row">
          <div class="form-group">
            ...
            <input id="nombre_curso" v-model="form.nombre_curso" type="text" placeholder="Ej: 1°A" required />
          </div>
          <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input id="ciclo_lectivo" v-model="form.ciclo_lectivo" type="number" min="2000" max="2100" required />
          </div>
          <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input id="aula" v-model="form.aula" type="text" placeholder="Ej: 101" required />
          </div>
          <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input id="capacidad_maxima" v-model="form.capacidad_maxima" type="number" min="1" placeholder="Opcional" />
          </div>
...
const confirmarEliminar = async () => {
  ...
  cursos.value = cursos.value.filter((c) => c.id_curso !== cursoAEliminar.value.id_curso);
