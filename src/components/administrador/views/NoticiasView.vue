        ...
        >
            ...
            <div class="table-responsive">
                ...
                <div v-else class="empty-state">
                    ...
                    ></i>
                    <p>
                        No hay noticias ni comunicados publicados actualmente.
                    </p>
                </div>
            </div>
        </div>
...
async function guardarNoticia() {
    ...
    try {
        ...
        if (vistaActiva.value === "crear") {
            ...
            const actualizada = await modificarNoticia(
...
async function confirmarEliminar() {
    ...
    errorEliminar.value = "";
    try {
        await eliminarNoticia(noticiaAEliminar.value.id_noticia);
        noticias.value = noticias.value.filter(
            (n) => n.id_noticia !== noticiaAEliminar.value.id_noticia,
        );
        noticiaAEliminar.value = null;
    } catch {
        errorEliminar.value = "Ocurrió un error al eliminar el comunicado.";
    } finally {
