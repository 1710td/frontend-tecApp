    ...
    <div class="auth-card">
      ...
      <form v-if="step === 1" @submit.prevent="solicitarCodigo" class="auth-form">
        ...
        <div class="field-group">
          ...
          <input v-model="registroData.fecha_nacimiento" type="date" class="field-input" required />
          ...
          <small class="field-help"> Verificaremos tu identidad y enviaremos un código de confirmación al correo indicado. </small>
        </div>
      ...
      <form v-else @submit.prevent="verificar" class="auth-form">
        ...
        <button type="button" class="btn-link" @click="step = 1">← Volver a ingresar DNI</button>
      </form>
